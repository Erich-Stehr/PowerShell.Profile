# from <https://michlstechblog.info/blog/powershell-show-a-messagebox/>
...
[System.Windows.Forms.MessageBox]::Show($Message, $Caption, $MessageBoxButtons, $MessageBoxIcon, $MessageBoxDefaultButton, $MessageBoxOptions, $false)
