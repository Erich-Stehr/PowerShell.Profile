...
$IssueList = 'Bug/Accessibility','Bug/Code Bug','Bug/Design Bug','Bug/External','Bug/Geopolitical','Bug/Globalization','Bug/Localization','Bug/Partner Bug','Bug/Spec Bug','Bug/Test Bug','DCR','Work Item/Dev','Work Item/PM','Work Item/Spec','Work Item/Test','Work Item/Tracking','Documentation'
SitesFrom 'https://liveserver.team.partners.extranet.microsoft.com/Companies' $NetCred |
#	? { $_.URL -match '/test' } |
#	select-object -last 2 |
	% { write-host $_.Title
		ResetChoiceList ($_.URL) 'Provide Product FeedBack' 'Issue_x0020_type' $IssueList 1 $NetCred
		ResetChoiceList ($_.URL) 'View Bugs' 'Issue_x0020_type' $IssueList 1 $NetCred 
	}
