...
if (!$noAzure) {
	push-location "c:\evsSrc\relevance\private\packages\Ares.Product\src\scraperservice\Tools"
...
.EXAMPLE
    PS> Package-ScraperService.ps1 \\builds\qdrops\view_Relevance-Infra-Ares_amd64_retail\3764333\a58729 -noAzure -noDtap -noQ19 -noFlighting -noIndia

    Builds q17/Central package only for build 3764333
.EXAMPLE
    PS> Package-ScraperService.ps1 \\builds\qdrops\view_Relevance-Infra-Ares_amd64_retail\3764333\a58729
