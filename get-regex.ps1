...
## http://poshcode.org/759  get-regex.ps1 is a Regular Expression Quick Reference for .NET/C#/Powershell.  It provides a quick dump of info in a PSCustomObject for quick access from a prompt. It is more complete than what is available in get-help.
## via http://thepowershellguy.com/blogs/posh/archive/2008/12/30/monday-december-29-2008-5-16-pm-regular-expressions-and-powershell-part-2.aspx
